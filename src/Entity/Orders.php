...
class Orders
{
    ...
    private ?PromoCoupons $promo_coupons = null;
    ...
    public function getPromoCoupons(): ?PromoCoupons
    {
        return $this->promo_coupons;
    }

    public function setPromoCoupons(?PromoCoupons $promo_coupons): static
    {
        $this->promo_coupons = $promo_coupons;
